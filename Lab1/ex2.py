...
def plot_and_save_2d(data, title, filename, colormap):
    ...
    plt.title(title)
    plt.colorbar()
    tool.save_figure(fig, filename.split('/')[-1], lab_name='Lab1')
    plt.show()


signals_to_plot = [
    {"name": "a) Sin 400 Hz with 1600 samples", "type": SignalType.SINE, "freq": 400, "duration": 1600/8000, "filename": 'a_sinus_400Hz'},
    {"name": "b) Sin 800 Hz, duration 3s", "type": SignalType.SINE, "freq": 800, "duration": 3, "filename": 'b_sinus_800Hz'},
    {"name": "c) Sawtooth 240 Hz", "type": SignalType.SAWTOOTH, "freq": 240, "duration": 0.02, "filename": 'c_sawtooth_240Hz'},
    {"name": "d) Square 300 Hz", "type": SignalType.SQUARE, "freq": 300, "duration": 0.01, "filename": 'd_square_300Hz'}
]
